...
export default function FunctionManagerFilters({
  openDateRange,
  onCloseDateRange,
  onOpenDateRange,
  //
  ...
  const renderStatus = filters.statuses.length ? filters.statuses : 'All statuses';
    ...
    <>
      ...
      <CustomPopover open={statusPopover.open} onClose={statusPopover.onClose} sx={{ p: 2.5 }}>
        <Stack spacing={2.5}>
          ...
          <Stack spacing={1.5} direction="row" alignItems="center" justifyContent="flex-end">
            <Button size="small" variant="outlined" color="inherit" onClick={handleResetStatuses}>
              Clear
            </Button>

            <Button size="small" variant="contained" onClick={statusPopover.onClose}>
              Apply
            </Button>
          </Stack>
        </Stack>
