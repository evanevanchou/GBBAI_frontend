...
import CopilotMessageList from './function-details-copilot-message-list';
import FunctionDetailsCopilotInput from './function-details-copilot-input';
import {
  codeInitialMessges,
  metaInitialMessges,
} from './function-details-copilot-initial-messages';
