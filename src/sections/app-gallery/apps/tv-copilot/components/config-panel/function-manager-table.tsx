...
import FunctionManagerTableRow from './function-manager-table-row';
...
type Props = {
  ...
  tableData: IFunction[];
  notFound: boolean;
  dataFiltered: IFunction[];
};

export default function FunctionManagerTable({ table, tableData, notFound, dataFiltered }: Props) {
