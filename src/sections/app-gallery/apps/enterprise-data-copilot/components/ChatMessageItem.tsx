...
const ContentStyle = styled('div')(({ theme }) => ({
  ...
  boxShadow: `0 0 1px 0 ${alpha(
    theme.palette.mode === 'light' ? theme.palette.grey[500] : theme.palette.grey[400],
    0.52
  )}, 0 1px 3px -1px ${alpha(
    ...
    try {
      ...
      return (
        ...
        >
          {isMe && (
            <Box
              sx={{ py: 1.5, wordBreak: 'break-word', typography: 'body1', whiteSpace: 'pre-line' }}
            >
              {content}
            </Box>
          )}
    ...
    !isSystemMsg && (
      <>
        ...
        <Stack
          ...
          direction="row"
          alignItems="center"
          sx={{ mt: -0.25, mb: 0.5, maxWidth: '100%' }}
        >
