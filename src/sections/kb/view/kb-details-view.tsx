...
import { useGetKbMeta } from 'src/api/kmm';
...
import KbDetailsTable from '../kb-details-top-table';
import KbManagerRoot from '../kn-kb/file-manager-root';
...
export default function KbDetailsView({ id }: Props) {
  ...
  const { kbMeta, isLoading } = useGetKbMeta(id, refreshKey);
