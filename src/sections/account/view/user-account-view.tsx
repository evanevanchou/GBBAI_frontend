...
import AccountAoai from '../account-aoai';
...
export default function AccountView() {
  ...
  const comeSoonContent = (
    <Stack sx={{ alignItems: 'center' }}>
      ...
      <MaintenanceIllustration sx={{ my: 10, height: 220 }} />
    </Stack>
  );
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
      ...
      <Alert variant="outlined" severity="info" sx={{ mb: 3, alignItems: 'center' }}>
        <Box sx={{ mb: 1 }}>
          1. Your credentials will be stored only in the <strong>LOCAL</strong> storage of your web
          browser. They will be removed from local storage once you log out.
        </Box>
        <Box>
          2. You can download the credential file to your local disk and import it the next time you
          log in.
        </Box>
      </Alert>
